...
export const schema = z.object({
  ...
  quantity: z.string(), // NEW field (e.g., "12 km", "5 kg")
  activityCO2: z.number(),
})
...
const columns = [
  ...
  },
  {
    ...
    header: "Description",
    cell: ({ row }) => <div className="text-sm">{row.original.activityDescription}</div>,
  },
  {
  ...
  {
    accessorKey: "activityCO2",
    header: "CO₂ (kg)",
    cell: ({ row }) => <div className="text-right">{row.original.activityCO2}</div>,
  },
]
  ...
  return (
    <Tabs defaultValue="logs" className="w-full flex-col justify-start gap-6">
      <div className="flex items-center justify-between px-4 lg:px-6">
        <TabsList>
          <TabsTrigger value="logs">Carbon Footprint Activity Logs</TabsTrigger>
        </TabsList>
